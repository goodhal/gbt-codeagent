...
export const LANGUAGE_VULN_MAP = {
  java: ['COMMAND_INJECTION', 'SQL_INJECTION', 'CODE_INJECTION', 'PATH_TRAVERSAL', 'XSS', 'XXE',
    'DESERIALIZATION', 'SSRF', 'AUTH_BYPASS', 'WEAK_CRYPTO', 'SPEL_INJECTION', 'JNDI_INJECTION',
    'TEMPLATE_INJECTION', 'LOG_INJECTION', 'OPEN_REDIRECT', 'IDOR', 'AUTH_MISSING', 'INFO_LEAK',
    'FILE_UPLOAD', 'CSRF', 'SSTI'],
  python: ['COMMAND_INJECTION', 'SQL_INJECTION', 'CODE_INJECTION', 'PATH_TRAVERSAL', 'DESERIALIZATION',
    'SSRF', 'WEAK_CRYPTO', 'HARD_CODE_PASSWORD', 'TEMPLATE_INJECTION', 'LOG_INJECTION', 'OPEN_REDIRECT',
    'XXE', 'XSS', 'IDOR'],
  javascript: ['COMMAND_INJECTION', 'SQL_INJECTION', 'XSS', 'SSRF', 'OPEN_REDIRECT', 'CSRF',
    'PATH_TRAVERSAL', 'CODE_INJECTION', 'DESERIALIZATION', 'TEMPLATE_INJECTION', 'LOG_INJECTION',
    'XXE', 'IDOR'],
  typescript: ['COMMAND_INJECTION', 'SQL_INJECTION', 'XSS', 'SSRF', 'OPEN_REDIRECT', 'CSRF',
    'PATH_TRAVERSAL', 'CODE_INJECTION', 'DESERIALIZATION', 'TEMPLATE_INJECTION', 'LOG_INJECTION',
    'XXE', 'IDOR'],
  go: ['COMMAND_INJECTION', 'SQL_INJECTION', 'PATH_TRAVERSAL', 'SSRF', 'WEAK_CRYPTO',
    'CODE_INJECTION', 'TEMPLATE_INJECTION', 'OPEN_REDIRECT', 'XXE', 'XSS'],
  cpp: ['COMMAND_INJECTION', 'SQL_INJECTION', 'CODE_INJECTION', 'PATH_TRAVERSAL', 'BUFFER_OVERFLOW',
    'FORMAT_STRING', 'INTEGER_OVERFLOW', 'LOG_INJECTION', 'INFO_LEAK'],
  csharp: ['COMMAND_INJECTION', 'SQL_INJECTION', 'CODE_INJECTION', 'PATH_TRAVERSAL',
    'DESERIALIZATION', 'XSS', 'SSRF', 'XXE', 'OPEN_REDIRECT', 'TEMPLATE_INJECTION', 'LOG_INJECTION',
    'CSRF', 'IDOR'],
  php: ['COMMAND_INJECTION', 'SQL_INJECTION', 'XSS', 'PATH_TRAVERSAL', 'SSRF', 'CODE_INJECTION',
    'DESERIALIZATION', 'OPEN_REDIRECT', 'CSRF', 'XXE', 'TEMPLATE_INJECTION', 'LOG_INJECTION'],
  ruby: ['COMMAND_INJECTION', 'SQL_INJECTION', 'CODE_INJECTION', 'PATH_TRAVERSAL', 'SSRF',
    'DESERIALIZATION', 'XSS', 'XXE', 'OPEN_REDIRECT', 'TEMPLATE_INJECTION'],
  rust: ['COMMAND_INJECTION', 'SQL_INJECTION', 'PATH_TRAVERSAL', 'SSRF', 'CODE_INJECTION',
    'TEMPLATE_INJECTION', 'OPEN_REDIRECT']
};
